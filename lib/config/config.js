...
var Config = /** @class */ (function () {
    function Config() {
        this.mongodbURI = "mongodb://shoeAdmin:ZrvtqCDCKWF4829@35.184.211.242:27017/shoeSystem";
        this.port = 3000;
        this.msg91authKey = "283313AMizXlXLsTJ5d19a5fb";
        this.paymentHtml = "<!DOCTYPE html>\
    <html>\
    <head>\
    <title>Payment</title>\
    <style>\
    ...
    <a href='paymentLink' class='btn' target='_blank'>Pay Now (amount)</a>\
        ...
        this.paymentHtml2 = '<!DOCTYPE html>\
    <html lang="en">\
    <head>\
    <meta charset="utf-8">\
